 ...
 * event listener.
 */
Ext.define('MyApp.view.verticalslider.SliderField', {
    extend  : 'Ext.field.Field',
    xtype   : 'verticalsliderfield',
    requires: ['MyApp.view.verticalslider.Slider'],
    alternateClassName: 'Ext.form.VerticalSlider',
    ...
    */
    ...
    applyComponent: function(config) {
        return Ext.factory(config, MyApp.view.verticalslider.Slider);
    },
