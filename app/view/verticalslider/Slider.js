 ...
 * @private
 */
Ext.define('MyApp.view.verticalslider.Slider', {
    extend: 'Ext.Container',
    xtype: 'verticalslider',

    requires: [
        'MyApp.view.verticalslider.Thumb',
    ...
    */
    ...
    factoryThumb: function() {
        return Ext.factory(this.getThumbConfig(), MyApp.view.verticalslider.Thumb);
    },
    ...
    refreshOffsetValueRatio: function() {
        ...
        var valueRange = this.getMaxValue() - this.getMinValue(),
            trackHeight = this.elementHeight;
    ...
    onThumbDrag: function(thumb, e, offsetX, offsetY) {
        ...
        var index = this.getThumbIndex(thumb),
            ...
            constrainedValue = this.constrainValue(this.getMaxValue() - offsetY / offsetValueRatio);
    ...
    setIndexValue: function(index, value, animation) {
        ...
        draggable.setOffset(null, this.elementHeight - (this.thumbHeight) - (value - this.getMinValue()) * offsetValueRatio, animation);
    ...
    onTap: function(e) {
        ...
        var touchPointY = e.touch.point.y,
            ...
            value = this.constrainValue(this.getMaxValue() - offset / this.offsetValueRatio),
            values = this.getValue(),
    ...
    updateValue: function(newValue, oldValue) {
        ...
        for (i = 0; i < ln; i++) {
            ...
            this.setIndexValue(i,newValue[i]);
        }
